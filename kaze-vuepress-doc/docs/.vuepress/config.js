...
module.exports = {
  ...
  themeConfig: {
    ...
    author: { // 文章默认的作者信息，可在md文件中单独配置此信息 String | {name: String, href: String}
      name: 'Kaze', // 必需
      href: 'https://github.com/egoistsh' // 可选的
    },
    social: { // 社交图标，显示于博主信息栏和页脚栏
      ...
      icons: [
        ...
        },
        {
          ...
          title: 'GitHub',
          link: 'https://github.com/egoistsh'
        },
        {
          iconClass: 'icon-erji',
          title: '听音乐',
